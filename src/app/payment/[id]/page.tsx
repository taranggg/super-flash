      ...
      <main>
        <SectionContainer className="text-center pt-16 pb-8">
          ...
          <div className="flex justify-center gap-4 mt-4">
            <span className="px-3 py-1 rounded bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 text-xs">
              Verified
            </span>
            <span className="px-3 py-1 rounded bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs">
              10-15 min delivery
            </span>
          </div>
        </SectionContainer>
        <SectionContainer>
          ...
          <form className="max-w-xl mx-auto grid gap-6">
            <select className="px-4 py-3 rounded bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700">
        ...
        <SectionContainer>
          ...
          <ul className="list-decimal pl-6 space-y-2 text-zinc-700 dark:text-zinc-300">
